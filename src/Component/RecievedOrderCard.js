...
import { declineOrder, acceptOrder, getProductbyId } from "../AppApi";
...
export default function RecievedOrderCard(props) {
  ...
  const handleClick = (event) => {
    ...
    navigator.clipboard.writeText(props.value.user.mobile);
    setOpenSnack(true);
  };
  ...
  return (
    <Paper className={classes.root}>
      ...
      <Snackbar
        ...
        message={`${props.value.user.mobile} copied to clipboard`}
        action={
          <>
            <IconButton
              size="small"
